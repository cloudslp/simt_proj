    ...
    <form action="{""|fn_url}" method="post" class="form-horizontal form-edit{if !$allow_save || $hide_inputs} cm-hide-inputs{/if}" name="devisions_form" enctype="multipart/form-data">
        ...
        <div id="content_general">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    {include 
                        ...
                        date_id="elm_devision_timestamp_`$id`" 
                        date_name="devision_data[timestamp]" 
                        date_val=$devision.timestamp|default:$smarty.const.TIME 
            ...
            {include 
                ...
                input_name="devision_data[status]" 
                id="elm_devision_status" 
                obj_id=$id 
                obj=$devision 
                hidden=false
            }
        ...
        {capture name="buttons"}
            {if !$id}
                {include file="buttons/save_cancel.tpl" 
                    ...
                    but_target_form="devisions_form" 
                    but_name="dispatch[profiles.update_devision]"
                }
            {else}
                {include file="buttons/save_cancel.tpl" 
                    but_name="dispatch[profiles.update_devision]" 
